...
$routes->group('api', function($routes) {
    ...
    $routes->group('admin', ['filter' => 'auth'], function($routes) {
        ...
        $routes->get('news', 'Admin::getNews');
        $routes->post('news/create', 'Admin::createNews');
        $routes->post('news/highlight/(:num)', 'Admin::toggleHighlight/$1');
        $routes->delete('news/(:num)', 'Admin::deleteNews/$1');

        $routes->get('teams', 'Admin::getTeams');
